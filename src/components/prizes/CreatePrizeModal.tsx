                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">
                        Select which terms and conditions apply to this prize.
                      </p>
                    </div>
                          ...
                          >
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1 space-y-3">
                                <div>
                                  <Label htmlFor="standard" className="text-sm font-semibold cursor-pointer">
                                    Standard Terms & Conditions
                                  </Label>
                                  <p className="text-xs text-muted-foreground mt-0.5">
                                    Use our pre-approved terms that cover standard prize fulfillment and liability.
                                  </p>
                                </div>

                                {useStandard && (
                                  <div className="space-y-3">
                                    <div className="flex items-center gap-3 bg-background border border-border rounded-md px-4 py-3">
                                      <FileText className="h-5 w-5 text-primary flex-shrink-0" />
                                      <div className="flex-1 min-w-0">
                                        <p className="text-sm font-medium">Standard Terms & Conditions</p>
                                    ...
                                    <div className="flex items-start gap-2.5 pl-1">
                                      ...
                                      <Label htmlFor="acceptTerms" className="text-xs leading-relaxed text-muted-foreground cursor-pointer">
                                        I have reviewed and accept the standard terms & conditions for this prize.
                                      </Label>
                                    </div>
                                  </div>
                                )}
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1 space-y-3">
                                <div>
                                  ...
                                  <p className="text-xs text-muted-foreground mt-0.5">
                                    Provide a URL to your own terms & conditions document.
                                  </p>
                                </div>
